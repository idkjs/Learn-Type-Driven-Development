...
let google: webapp = {name: "google", url: "https://google.com"};
let gmail: webapp = {name: "gmail", url: "https://google.com/gmail"};
let googleads: webapp = {name: "google ads", url: "https://ads.google.com"};
let googleplus: webapp = {name: "google+", url: "https://plus.google.com"};

/* Platform module, signature followed by implementation */

module type PlatformType = {let apps: pfcompany => string;};
